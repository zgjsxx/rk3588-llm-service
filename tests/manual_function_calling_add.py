...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Manual function-calling test client for the local RKLLM OpenAI-compatible service."
    )
    parser.add_argument(
        "--api-base",
    ...
    parser.add_argument(
        "--prompt",
        default="Please add 12 and 30. If needed, call the add function.",
    ...
    parser.add_argument(
        ...
        default="auto",
        help="Tool choice policy. 'force' maps to a forced add function call.",
    )
    parser.add_argument(
        "--timeout",
        type=float,
...
def build_payload(args: argparse.Namespace) -> dict[str, Any]:
    ...
    if args.tool_choice == "force":
        payload["tool_choice"] = {"type": "function", "function": {"name": "add"}}
    else:
